                ...
                try:
                    ...
                    match job_type:
                        ...
                        case "yt_id":
                            pass
                        case "seed_id":
                            job_metadata = await self.audio_database.get_metadata(job_id, artist_delim=",", include_artists=False) #need searchable display for metadata so use , as delimiter
